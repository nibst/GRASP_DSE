...
short Real[Input_Size];
short Imag[Input_Size];
short New_Real[Input_Size];
short New_Imag[Input_Size]; 
...
int main(int argc, char *argv[])
{
	...
	populateInput(Real, Input_Size, argv[1]);
  	fft(Real, Imag, New_Real, New_Imag);
	populateOutput(New_Real, New_Imag, Input_Size, argv[2]);
