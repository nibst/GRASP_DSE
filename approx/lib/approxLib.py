...
import subprocess
import numpy  
from grasp_dse.domain.designToolFactory import DesignToolFactory
from grasp_dse.domain.solution import Solution
from math import floor, ceil, sqrt, log

from grasp_dse.utils.Script_tcl import generateScriptWithInputIR
...
def getOutputsValuesAndDataStats(bytecodeFile: Path, inputsDir: Path, outputsDir: Path, dataStatsDir: Path, deleteOutputFiles=False) -> Tuple[dict, dict]:
