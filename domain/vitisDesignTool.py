...
class Vitis(DesignTool):
    ...
    def runSynthesis(self, solution: Solution, timeLimit = None, solutionSaver= None):
        ...
        results = self.getResultsFromSynthesis(solution,xml)
        for key in results:
    ...
    def getResultsFromSynthesis(self, solution:Solution, xmlPath:str):   
        ...
        if os.path.exists(xmlPath):  
            ...
            results['resources'] =  results['FF'] * solution.FF_VALUE + results['LUT'] * solution.LUT_VALUE + results['DSP'] * solution.DSP_VALUE + results['BRAM'] * solution.BRAM_VALUE    
