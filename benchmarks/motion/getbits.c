 ...
 *
 */
#include "global.h"  //mod Heitor
#include "getbits.h" //mod Heitor
...
void Fill_Buffer()
{
  ...
  if (Buffer_Level < 2048)
  {
    ...
    Fill_Buffer_label3:while (Buffer_Level & 3)
      ld_Rdbfr[Buffer_Level++] = 0;

    /* pad the buffer with sequence end codes */
    Fill_Buffer_label4:while (Buffer_Level < 2048)
    {
