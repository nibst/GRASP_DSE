...
struct sha_stream : public sc_module {
    ...
    sc_signal< sc_lv<4> > sha_info_data_address1;
    sc_signal< sc_logic > sha_info_data_ce1;
    sc_signal< sc_logic > sha_info_data_we1;
    sc_signal< sc_lv<32> > sha_info_data_q1;
    ...
    sc_signal< sc_lv<4> > grp_sha_transform_fu_124_sha_info_data_address1;
    sc_signal< sc_logic > grp_sha_transform_fu_124_sha_info_data_ce1;
    ...
    sc_signal< sc_lv<6> > empty_5_fu_144_p1;
