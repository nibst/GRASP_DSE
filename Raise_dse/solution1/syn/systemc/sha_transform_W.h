...
struct sha_transform_W_ram : public sc_core::sc_module {
...
sha_transform_W_ram* meminst;


SC_CTOR(sha_transform_W) {
meminst = new sha_transform_W_ram("sha_transform_W_ram");
