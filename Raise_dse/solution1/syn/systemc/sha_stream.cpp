...
sha_stream::sha_stream(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sha_info_data_U->address1(sha_info_data_address1);
    sha_info_data_U->ce1(sha_info_data_ce1);
    sha_info_data_U->we1(sha_info_data_we1);
    sha_info_data_U->d1(ap_var_for_const0);
    sha_info_data_U->q1(sha_info_data_q1);
    ...
    grp_sha_transform_fu_124->sha_info_data_address1(grp_sha_transform_fu_124_sha_info_data_address1);
    grp_sha_transform_fu_124->sha_info_data_ce1(grp_sha_transform_fu_124_sha_info_data_ce1);
    grp_sha_transform_fu_124->sha_info_data_q1(sha_info_data_q1);
    ...
    SC_METHOD(thread_empty_5_fu_144_p1);
    sensitive << ( p_1_rec_i_reg_113 );
    ...
    sensitive << ( ap_CS_fsm_state5 );
    sensitive << ( grp_sha_transform_fu_124_sha_info_data_address1 );
    sensitive << ( ap_CS_fsm_state7 );
    ...
    sensitive << ( ap_CS_fsm_state5 );
    sensitive << ( grp_sha_transform_fu_124_sha_info_data_ce1 );
    sensitive << ( ap_CS_fsm_state7 );
    ...
    sc_trace(mVcdFile, sha_info_data_address1, "sha_info_data_address1");
    sc_trace(mVcdFile, sha_info_data_ce1, "sha_info_data_ce1");
    sc_trace(mVcdFile, sha_info_data_we1, "sha_info_data_we1");
    sc_trace(mVcdFile, sha_info_data_q1, "sha_info_data_q1");
    ...
    sc_trace(mVcdFile, grp_sha_transform_fu_124_sha_info_data_address1, "grp_sha_transform_fu_124_sha_info_data_address1");
    sc_trace(mVcdFile, grp_sha_transform_fu_124_sha_info_data_ce1, "grp_sha_transform_fu_124_sha_info_data_ce1");
    ...
    sc_trace(mVcdFile, empty_5_fu_144_p1, "empty_5_fu_144_p1");
...
void sha_stream::thread_empty_5_fu_144_p1() {
    empty_5_fu_144_p1 = p_1_rec_i_reg_113.read().range(6-1, 0);
}
...
void sha_stream::thread_sha_info_data_address1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        sha_info_data_address1 = ap_const_lv4_F;
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        sha_info_data_address1 = grp_sha_transform_fu_124_sha_info_data_address1.read();
    } else {
...
void sha_stream::thread_sha_info_data_ce1() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        ...
        sha_info_data_ce1 = grp_sha_transform_fu_124_sha_info_data_ce1.read();
    } else {
...
void sha_stream::thread_sum_i_fu_148_p2() {
    sum_i_fu_148_p2 = (!ap_const_lv6_1.is_01() || !empty_5_fu_144_p1.read().is_01())? sc_lv<6>(): (sc_biguint<6>(ap_const_lv6_1) + sc_biguint<6>(empty_5_fu_144_p1.read()));
}
