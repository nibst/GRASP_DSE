...
(* CORE_GENERATION_INFO="sha_stream,hls_ip_2020_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-1-e,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.883000,HLS_SYN_LAT=416,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=1187,HLS_SYN_LUT=2286,HLS_VERSION=2020_1}" *)
...
always @ (posedge ap_clk) begin
    if (((icmp_ln210_fu_132_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln210_fu_132_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        p_1_rec_i_reg_113 <= 64'd0;
    end else if (((icmp_ln64_fu_163_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | ((1'b1 == ap_CS_fsm_state5) & (icmp_ln64_fu_163_p2 == 1'd1)) | ((icmp_ln64_fu_163_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5)))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state5) & (icmp_ln64_fu_163_p2 == 1'd1)) | ((icmp_ln64_fu_163_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5)))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state5) & (icmp_ln64_fu_163_p2 == 1'd1)) | ((icmp_ln64_fu_163_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5)) | ((icmp_ln210_fu_132_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((icmp_ln64_fu_163_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state5;
            end else begin
...
assign empty_10_fu_144_p1 = p_1_rec_i_reg_113[5:0];
...
assign sum_i_fu_148_p2 = (6'd1 + empty_10_fu_144_p1);
